switch(argument0)
{
    ...
    case seaweed: audio_play_sound(snd_grab, 100, false);
    case quarter: audio_play_sound(snd_grab, 100, false);
    case stud: audio_play_sound(snd_grab, 100, false);
    case rock1: audio_play_sound(snd_grab, 100, false);
    case rock2: audio_play_sound(snd_grab, 100, false);
    case driftwood: audio_play_sound(snd_grab, 100, false);
}
